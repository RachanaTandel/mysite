...
<form method="post" action="/mysite/servlet/addemailaddress">
	<table  cellpadding="0" cellspacing="0" width="50%"">
		...
		<tr>
			...
			<td><input type="text" name="hphone" maxlength="10" value="" /></td>
		</tr>
		<tr>
			<td bgcolor="#FAFAF9" style="padding-left: 10px;">Work Phone</td>
			<td><input type="text" name="wphone" maxlength="10" value="" /></td>
		</tr>
		<tr>
			<td bgcolor="#FAFAF9" style="padding-left: 10px;">Mobile Phone</td>
			<td><input type="text" name="mphone" maxlength="10" value="" /></td>
		</tr>
