...
// EMailAddress Queries
	...
	public static EMailAddressVOO getEMailAddress(String inEMailID) throws Exception{
		...
		if (rs.next()) {
			eMailAddressVoo = new EMailAddressVOO(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5),
						rs.getString(6), rs.getString(7), rs.getString(8));

		System.out.println(eMailAddressVoo.getfName());
        System.out.println(eMailAddressVoo.gethPhone());
        System.out.println("EmailAddressVOOOOO "  +eMailAddressVoo);

   		}else{
   			System.out.println("No contact found with the given email.");
   			//throw new EMailValidationException("No contact found with the given email.");
		}
	     }catch (SQLException sqle) {
		   sqle.printStackTrace();
		}
		...
		dbConn.close();
	     ...
	     System.out.println(eMailAddressVoo);
		return eMailAddressVoo;
	}
	...
	public static ArrayList getAllEMailAdressEntries() throws Exception{
		...
		//System.out.println("First nameeeeeeeeeeeeee: " + eMailAddress.getfName());
	...
	public static ArrayList getAllEMailAdressEntriesbyGroup(String inGroupID) throws Exception{
	    ...
	    EMailAddressVOO eMailAddress = null;
	     ...
	     try{
	         ...
	         while (rs.next()) {
	              eMailAddress = new EMailAddressVOO(
	                     rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4),
	                     rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8)
	             );
	             eMailList.add(eMailAddress);
	             System.out.println(i + eMailAddress.geteMailID());
	             i++;
	             //System.out.println(eMailAddress.gethPhone());
...
public void addEMailAddress(String eMailAddress, String getwPhone, String getmPhone) throws Exception {
      ...
      try {
          ...
          String sql = "UPDATE emailaddress SET workphoneno = ?, mobileno = ? WHERE emailaddress = ?";
          pstmt = dbConn.prepareStatement(sql);
          pstmt.setString(1, getwPhone);
          pstmt.setString(2, getmPhone);
