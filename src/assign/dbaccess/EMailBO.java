...
public class EMailBO {
	...
	public EMailAddressVOO getEMailAddress(String inEMailID) throws EMailValidationException, Exception{
		...
		System.out.println("getemailaddress -emailbo "+inEMailID);
...
public static void updatePhoneNumbers(String eMailAddress, String getwPhone, String getmPhone) throws Exception {
	EMailDBAccess eMailDBAccess = new EMailDBAccess();
	eMailDBAccess.addEMailAddress(eMailAddress, getwPhone, getmPhone);
